...
const sidebarItems = [
  { icon: Home, label: "Dashboard", href: "/traveler" },
  { icon: Plane, label: "My Trips", href: "/traveler/trips" },
...
export function TravelerLayout({ children }: TravelerLayoutProps) {
    ...
    <div className="h-dvh bg-gray-50 dark:bg-black flex overflow-x-hidden">
      ...
      >
        ...
        <div className="p-4 border-b border-gray-200 dark:border-gray-800 flex items-center justify-between">
          <Link href="/traveler" onClick={closeSidebar}>
