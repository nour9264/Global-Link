        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600 mt-1">View and manage your trip information</p>
            </div>
          </div>
          <div className="flex gap-3">
            <Button
              variant="outline"
              className="gap-2"
              onClick={() => router.push(`/traveler/trips/${tripId}/edit`)}
            >
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <Card className="p-6">
              <div className="flex items-center justify-between mb-6">
                <div>
                  ...
                  <p className="text-sm text-gray-600">Requests Enrolled</p>
            ...
            <Card className="p-6">
              ...
              <div className="space-y-4">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    <p className="text-sm font-medium text-gray-700 mb-1">Departure Date & Time</p>
                    <p className="text-sm text-gray-900">{formatDate(trip.departureDate)}</p>
                  </div>
                  <div>
                    <p className="text-sm font-medium text-gray-700 mb-1">Return Date & Time</p>
                    <p className="text-sm text-gray-900">{formatDate(trip.returnDate)}</p>
                  </div>
                </div>
                
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    <p className="text-sm font-medium text-gray-700 mb-1">Available Capacity</p>
                    <p className="text-sm text-gray-900">{trip.capacityKg} kg</p>
                  </div>
                  <div>
                    <p className="text-sm font-medium text-gray-700 mb-1">Max Package Weight</p>
                    <p className="text-sm text-gray-900">{trip.maxPackageWeightKg} kg per package</p>
                  </div>
                </div>
                ...
                {trip.receiveWindowStartUtc && trip.receiveByDeadlineUtc && (
                  <div>
                    <p className="text-sm font-medium text-gray-700 mb-2">Receiving Window</p>
                ...
                {trip.createdAt && (
                  <div>
                    <p className="text-sm font-medium text-gray-700 mb-1">Trip Created</p>
                    <p className="text-sm text-gray-900">{formatDate(trip.createdAt)}</p>
                  </div>
                )}
              </div>
            </Card>
              ...
              <div className="space-y-3">
                ...
                {trip.updatedAt && (
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-sm text-gray-900">{formatDate(trip.updatedAt)}</span>
                  </div>
                )}
              </div>
            </Card>
